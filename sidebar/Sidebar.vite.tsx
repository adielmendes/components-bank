...
import { cn } from "@/lib/utils"; // shadcn default — ou substitua por: (...c) => c.filter(Boolean).join(" ")
...
export function Sidebar({
  ...
  const { pathname } = useLocation(); // React Router v6
  ...
  return (
    ...
    >
      ...
      {/* Separator */}
      {!collapsed && <div className="mx-4 border-t border-white/[0.08]" />}
      ...
      <div className="shrink-0">
        ...
        <div className="px-3 py-3">
          <div
            className={cn(
              "flex w-full items-center gap-3 rounded-xl px-3 py-2.5 transition-colors duration-150 hover:bg-white/5 cursor-pointer",
              collapsed && "justify-center px-0"
            )}
          >
